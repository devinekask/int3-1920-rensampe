<section class="webshop">
  ...
  <form class="search" action="index.php" method="GET" class="search-form">
    <input class="search__field" type="search" name="term" class="search-field" value="<?php if(!empty($_GET['term'])) {echo $_GET['term'];} ?>">
    <button class="search__submit" type="submit" class="search-button">
